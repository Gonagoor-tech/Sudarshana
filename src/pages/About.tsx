          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-12">
            {[ 
              ...
              },
              {
                ...
                name: "Anath M Athreya",
                title: "Nirvaahak, Mathematics Expert",
                desc: "Specializes in applying advanced mathematical frameworks to semiconductor and AI architectures. Bridges ancient Vedic principles with modern computational models to drive innovation."
              },
              {
